...
const QUESTS := {
	...
	"eq11": {"name": "The Long Dark", "tier": 3, "prereq": [],
		"objective": "Survive the full 20:00 and defeat the timeline's final boss.",
		"reward": "5000 coins.",
		"trivia": "\"Ride the whole timeline down and be standing when the last thing dies.\"",
		"obj": {"type": "all", "of": [{"type": "survive", "t": 1200.0}, {"type": "final_boss"}]},
		"rw": [{"t": "coins", "n": 5000}]},
	"eq12": {"name": "Apex Predator", "tier": 3, "prereq": [],
		"objective": "Finish a 20:00 Electric run with 3,000+ kills and zero revives spent.",
		"reward": "3000 coins. +3% XP gain everywhere.",
		"trivia": "\"Full run. Three thousand kills. One life. The record to beat.\"",
		"obj": {"type": "kills_no_revive", "kills": 3000, "t": 1200.0},
