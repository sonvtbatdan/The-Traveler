...
func _ready() -> void:
	add_to_group("volcanic_sparks")   # so the Light Edit panel can find this instance
...
## Call every frame with the camera's world-space focus — mirrors volcanic_clouds.gd's set_world_offset.
