...
const M3_ENEMY_DEFS := {
	"fly": {"behavior": "chase", "hp": 20.0,   "speed": 120.0, "size": 7.2,  "contact": 2, "explodes": true, "xp": 1.0,  "icon": "res://assets/enemiesHD/animalflies.png"},
	"bug": {"behavior": "chase", "hp": 200.0,  "speed": 100.0, "size": 15.4, "contact": 3, "explodes": true, "xp": 5.0,  "icon": "res://assets/enemiesHD/animalbug.png"},
	"bee": {"behavior": "chase", "hp": 1000.0, "speed": 110.0, "size": 12.0, "contact": 3, "explodes": true, "xp": 10.0, "icon": "res://assets/enemiesHD/animalbee.png"},
}
