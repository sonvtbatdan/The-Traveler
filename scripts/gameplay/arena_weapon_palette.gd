...
const WEAPONS := [
	...
	{"kind": "thunderhead",   "def_id": "thunderhead",   "label": "Thunderhead"},
	{"kind": "graviton_well", "def_id": "graviton_well", "label": "Graviton Well"},
	{"kind": "omega_swarm",   "def_id": "omega_swarm",   "label": "Omega Swarm"},
	{"kind": "singularity_lance", "def_id": "singularity_lance", "label": "Singularity Lance"},
	{"kind": "prism_array",       "def_id": "prism_array",       "label": "Prism Array"},
	{"kind": "hailstorm",         "def_id": "hailstorm",         "label": "Hailstorm"},
	{"kind": "wraithfire",    "def_id": "wraithfire",    "label": "Wraithfire"},
	{"kind": "hivemind",      "def_id": "hivemind",      "label": "Hivemind"},
	{"kind": "annihilator",   "def_id": "annihilator",   "label": "Annihilator"},
	{"kind": "event_horizon", "def_id": "event_horizon", "label": "Event Horizon"},
]
