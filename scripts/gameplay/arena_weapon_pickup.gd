...
const KIND_STYLE := {
	...
	"gatling_gun": {"color": Color(1.0, 0.82, 0.25), "ring": Color(1.0, 0.9, 0.5),  "emblem": "tracer"},
	"defensive_orbitals": {"color": Color(0.65, 0.78, 0.95), "ring": Color(0.8, 0.9, 1.0), "emblem": "orb"},
	"offensive_orbitals": {"color": Color(1.0, 0.66, 0.22),  "ring": Color(1.0, 0.82, 0.45), "emblem": "orb"},
